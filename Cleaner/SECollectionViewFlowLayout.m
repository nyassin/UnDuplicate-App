...
- (BOOL)shouldStickHeaderToTopInSection:(NSUInteger)section{
    ...
    if ([self.collectionView.delegate conformsToProtocol:@protocol(SECollectionViewFlowLayoutDelegate)]) {
        id<SECollectionViewFlowLayoutDelegate> stickyHeadersDelegate=(id<SECollectionViewFlowLayoutDelegate>)self.collectionView.delegate;
